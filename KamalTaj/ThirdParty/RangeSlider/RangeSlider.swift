...
//
//        gradient.colors = [UIColor(hexString: "#E28A58"), UIColor(hexString: "#D03373")]
//        gradient.locations = [0.0 , 1.0]
//        gradient.startPoint = CGPoint(x: 0.0, y: 1.0)
//        gradient.endPoint = CGPoint(x: 1.0, y: 1.0)
//        gradient.frame = CGRect(x: 0.0, y: 0.0, width: self.frame.width, height: self.frame.height)
////        self.lowerThumbLayer.insertSublayer(gradient, at: 0)
...
public class RangeSlider: UIControl {
    ...
    @IBInspectable public var thumbTintColor: UIColor = UIColor.clear {
        didSet {
    ...
    func updateLayerFrames() {
        ...
        gradient.startPoint = CGPoint(x: 0.0, y: 1.0)
        gradient.endPoint = CGPoint(x: 1.0, y: 1.0)
        gradient.frame = CGRect(x: 0.0, y: 0.0, width: self.lowerThumbLayer.frame.width, height: self.lowerThumbLayer.frame.height)
        self.lowerThumbLayer.insertSublayer(gradient, at: 0)
